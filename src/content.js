const productData = [
    {
      id: 1,
      productname: "MASSDROP X SENNHEISER HD 6XX HEADPHONES",
      productimage:
    ...
    {
      id: 2,
      productname: "DROP + SENNHEISER PC38X GAMING HEADSET",
      productimage:
    ...
    {
      id: 3,
      productname: "MASSDROP X SENNHEISER HD 58X JUBILEE HEADPHONES",
      productimage:
